...
public final class AppUtils {
    ...
    public static String getMetaDataValue(Context context, String name) {
        ...
        try {
            ...
            Log.e("Apputils", "getMetaDataValue: " + name);

            metaDataString = ai.metaData.getString(name,
                    "1001282692527-nkhoo5ldn4142l8ijoi4c27qel9pu85o.apps.googleusercontent.com");
            Log.e("Apputils", "getMetaDataValue: " + metaDataString);
        } catch (PackageManager.NameNotFoundException e) {
            return null;
        }
